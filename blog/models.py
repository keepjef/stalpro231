...
class Partition(models.Model):
    ...
    preview = models.ImageField(upload_to='static/assets/images/preview', default='default.jpg', verbose_name='Изображение')
...
class Product(models.Model):
    ...
    img = models.ImageField(upload_to='static/assets/images/products', verbose_name='Изображение')
...
class ElPartition(models.Model):
    ...
    img = models.ImageField(upload_to='static/assets/images/elpartition', verbose_name='Изображение')
